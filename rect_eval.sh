...
python3 -m paddle.distributed.launch --gpus '0,1' tools/eval.py -c configs/rec/multi_language/rec_en_number_hungarian_lite_eval.yml -o Global.checkpoints=trained_model/eng/8_6/best_accuracy